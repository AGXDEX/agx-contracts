...
export namespace SetCustomCallbackGasLimitEvent {
  export type InputTuple = [
    callbackTarget: AddressLike,
    callbackGasLimit: BigNumberish
  ];
  export type OutputTuple = [callbackTarget: string, callbackGasLimit: bigint];
  export interface OutputObject {
    callbackTarget: string;
    callbackGasLimit: bigint;
  }
...
export interface PositionRouter extends BaseContract {
  ...
  setCustomCallbackGasLimit: TypedContractMethod<
    [_callbackTarget: AddressLike, _callbackGasLimit: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setCustomCallbackGasLimit"
  ): TypedContractMethod<
    [_callbackTarget: AddressLike, _callbackGasLimit: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "SetCustomCallbackGasLimit"
  ): TypedContractEvent<
    SetCustomCallbackGasLimitEvent.InputTuple,
    SetCustomCallbackGasLimitEvent.OutputTuple,
    SetCustomCallbackGasLimitEvent.OutputObject
  >;
  getEvent(
    key: "SetDelayValues"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "SetCustomCallbackGasLimit(address,uint256)": TypedContractEvent<
      SetCustomCallbackGasLimitEvent.InputTuple,
      SetCustomCallbackGasLimitEvent.OutputTuple,
      SetCustomCallbackGasLimitEvent.OutputObject
    >;
    SetCustomCallbackGasLimit: TypedContractEvent<
      SetCustomCallbackGasLimitEvent.InputTuple,
      SetCustomCallbackGasLimitEvent.OutputTuple,
      SetCustomCallbackGasLimitEvent.OutputObject
    >;
