...
export interface Timelock extends BaseContract {
  ...
  prevGlpManager: TypedContractMethod<[], [string], "view">;
  ...
  setMinter: TypedContractMethod<
    [_target: AddressLike, _minter: AddressLike, _isActive: boolean],
    [void],
    "nonpayable"
  >;
  ...
  signalSetMinter: TypedContractMethod<
    [_target: AddressLike, _minter: AddressLike, _isActive: boolean],
    [void],
    "nonpayable"
  >;
  ...
  updateUsdgSupply: TypedContractMethod<
    [_glpManager: AddressLike, usdgAmount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "prevGlpManager"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "signalSetMinter"
  ): TypedContractMethod<
    [_target: AddressLike, _minter: AddressLike, _isActive: boolean],
    [void],
    "nonpayable"
